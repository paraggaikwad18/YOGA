...
<form action="insert.php" method="post">
  ...
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" class="form-control" name="Month" id="inputMonth">
    </div>
    <div class="form-group col-md-4">
      <label for="inputState">Batch</label>
    <input type = "text" class = "form-control" name = "Batch" id="inputBatch"placeholder="6-7AM 7-8AM 8-9AM 5-6AM ONLY">
    </div>
    <div class="form-group col-md-2">
      <label for="inputZip">Phoneno</label>
      <input type="text" class="form-control" name="Phoneno" id="inputPhoneno">
    </div>
  </div>
  <div class="form-group">
  </div>
